  ...
  return (
    <>
      <div className="about-section">
        ...
        ></img>
        <p>
          Here at Sodoto we know that true mastery of a subject comes with that
          ability to teach that skill to others. Based on the “see one, do one,
          teach one” philosophy, we strive to be a platform where learners of
          all types can both teach and learn from each other.
        </p>
      </div>
      ...
      <div className="row" style={{ marginBottom: "150px" }}>
        ...
        ></img>       */}
            <div className="container" style={{ height: "auto" }}>
              <h2>How it works</h2>
              <p className="title">
                If you are here to reinforce your own learning by teaching it to
                others...
              </p>
              <ul>
                <li>
        ...
        ></img>       */}
            <div className="container" style={{ height: "auto" }}>
              <h2>How it works</h2>
              <p className="title">If you are here to share you thoughts</p>
